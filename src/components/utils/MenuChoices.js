...
export default function MenuChoices(prop) {
   ...
   return (
      <div className="w-full flex flex-col md:flex-row justify-between items-center md:px-44 md:h-80 3xl:px-80">
         ...
         {prop.href4 && <a href={prop.href4} onMouseEnter={() => setFourthHover(true)} onMouseLeave={() => setFourthHover(false)}>
            <img src={prop.main4}
